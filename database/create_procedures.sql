...
BEGIN
    ...
    insert into result(THOI_GIAN,TRANG_THAI,TU_DONG,TEN,GIO_BAT_DAU,GIO_KET_THUC,GIA_TRI) select THOI_GIAN,TRANG_THAI,TU_DONG,TEN,GIO_BAT_DAU,GIO_KET_THUC,GIA_TRI from THIET_LAP_THIET_BI join USER on THIET_LAP_THIET_BI.MA_USER=USER.MA_USER where THIET_LAP_THIET_BI.MA_TB=MA_TB;
    select * from result order by THOI_GIAN desc;
END $$
DELIMITER ;