...
CREATE TABLE THIET_BI (
    ...
    TU_DONG BOOL,
    PRIMARY KEY (MA_TB),
    CHECK((MA_TB LIKE 'DOOR%' AND TU_DONG IS NULL AND TRANG_THAI IS NULL) OR MA_TB LIKE 'FAN%' OR MA_TB LIKE 'LIGHT%')
);
...
CREATE TABLE THIET_LAP_THIET_BI(
	...
	GIO_KET_THUC TIME,
	-- NOI_DUNG text,
    PRIMARY KEY(THOI_GIAN,MA_USER,MA_TB),
...
CREATE TABLE THIET_LAP_CAM_BIEN(
	...
	NGUONG_DUOI FLOAT,
-- 	NOI_DUNG text,
    PRIMARY KEY(THOI_GIAN,MA_USER,MA_CB),
    FOREIGN KEY(MA_USER) REFERENCES USER(MA_USER) ON DELETE CASCADE ON UPDATE CASCADE,
