...
CREATE TABLE THIET_BI (
    ...
    TU_DONG BOOL,
    PRIMARY KEY (MA_TB),
    CHECK(MA_TB LIKE 'DOOR%' OR MA_TB LIKE 'FAN%' OR MA_TB LIKE 'LIGHT%'),
    CHECK(MA_TB LIKE 'DOOR%' AND TU_DONG IS NULL)
);
CREATE TABLE CAM_BIEN (
    ...
    NGUONG_DUOI FLOAT,
    PRIMARY KEY (MA_CB),
    CHECK (MA_CB LIKE 'HEAT%' OR MA_CB LIKE 'HUMID%' OR MA_CB LIKE 'LIGHT_INTENSE%' OR MA_CB LIKE 'IR%'),
    CHECK (MA_CB LIKE 'IR%' AND NGUONG_TREN IS NULL AND NGUONG_DUOI IS NULL)
...
CREATE TABLE DU_LIEU_THIET_BI(
    ...
    -- CHECK(MA_TB LIKE 'DOOR%' AND GIA_TRI IS NULL AND TU_DONG IS NULL AND GIO_BAT_DAU IS NULL AND GIO_KET_THUC IS NULL)
);
