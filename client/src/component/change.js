            ...
            <div className="w-75 h-75 login-board d-flex justify-content-center align-items-center">
                ...
                <div className="d-flex flex-column form">
                    ...
                    <form className="d-flex flex-column" onSubmit={handleForm}>
                        ...
                        {wrong && <div className="d-flex align-items-center" style={{ color: "red", fontSize: "1rem" }}><AiOutlineCloseCircle />Thông tin nhập chưa chính xác!</div>}
                        <input type="submit" value="Xác nhận" className="submit" />
                    </form>
                    <a href='/Login' className="text-decoration-none forgot">Quay lại</a>
                </div>
            </div >
        </div >
    );
