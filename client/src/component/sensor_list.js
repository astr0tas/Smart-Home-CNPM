          ...
          if (typeof (props.name) === "undefined" || props.name === '')
          {
                if (!render.current)
                {
                      $(".header")
                            ...
                            .append($("<th>").attr("scope", "col").addClass("col-2").addClass("text-center").addClass(styles.table_header).text("Nhiệt độ hiện tại(độ C)"))
    ...
    useEffect(() =>
    {
          ...
          if (typeof (props.name) === "undefined" || props.name === '')
          {
                if (!render.current)
                {
                      $(".header")
                            .append($("<th>").attr("scope", "col").addClass("col-2").addClass("text-center").addClass(styles.table_header).text("Trạng thái"))
                            .append($("<th>").attr("scope", "col").addClass("col-2").addClass("text-center").addClass(styles.table_header).text("Độ ẩm hiện tại(%)"))
                            .append($("<th>").attr("scope", "col").addClass("col").text("Tác vụ").css("padding-left", "15px").addClass(styles.table_header));
    ...
    useEffect(() =>
    {
          ...
          if (typeof (props.name) === "undefined" || props.name === '')
          {
                if (!render.current)
                {
                      $(".header")
                            .append($("<th>").attr("scope", "col").addClass("col-2").addClass("text-center").addClass(styles.table_header).text("Trạng thái"))
                            .append($("<th>").attr("scope", "col").addClass("col-2").addClass("text-center").addClass(styles.table_header).text("Cường độ ánh sáng(%)"))
                            .append($("<th>").attr("scope", "col").addClass("col").text("Tác vụ").css("padding-left", "15px").addClass(styles.table_header));
    ...
    useEffect(() =>
    {
          ...
          if (typeof (props.name) === "undefined" || props.name === '')
          {
                if (!render.current)
                {
                      $(".header")
                            .append($("<th>").attr("scope", "col").addClass("col-2").addClass("text-center").addClass(styles.table_header).text("Trạng thái"))
                            .append($("<th>").attr("scope", "col").addClass("col-2").addClass("text-center").addClass(styles.table_header).text("Lần phát hiện gần đây"))
                            .append($("<th>").attr("scope", "col").addClass("col").text("Tác vụ").css("padding-left", "15px").addClass(styles.table_header));
